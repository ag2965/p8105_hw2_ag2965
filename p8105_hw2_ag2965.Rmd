...
pols_month= subset(pols_month, select = -c(3,4,8))
```
...
mutate(
    ...
    year=replace(year, year == "3","2003"),
    year=replace(year, year == "4","2004"),
    year=replace(year, year == "5","2005"),
    year=replace(year, year == "6","2006"),
    year=replace(year, year == "7","2007"),
    year=replace(year, year == "8","2008"),
    year=replace(year, year == "9","2009"),
    year=replace(year, year == "10","2010"),
    year=replace(year, year == "11","2011"),
    year=replace(year, year == "12","2012"))%>%
arrange(year,month)
```
...
```{r}
pols_month_snp=left_join(snp,pols_month)
pols_month_snp_unemp=left_join(pols_month_snp,unemployment)
```
