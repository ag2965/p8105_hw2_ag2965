...
The total weight of trash collected by Professor Trash Wheel was `r sum(proftrash,pull(weight_tons)`
#need to fix this

The total number of sports balls collected by Mr. Trash Wheel in 2020 was `r filter(mrtrash, year==2020)%>%pull(sports_balls.x)%>%sum()` 
